...
export default function UploadEventForm() {
  ...
  const [pageComponent, setPageComponent] = useState("UPLOAD_EVENT_FORM");
  ...
  const handleUpload = async () => {
    ...
    if (postData) {
      setPageComponent("UPLOAD_EVENT_SUCCESS");
    }
  };

  return (
    <>
      {pageComponent === "UPLOAD_EVENT_FORM" && (
        <Box
          component="div"
          sx={{
            width: "auto",
      ...
      {pageComponent === "EVENT_UPLOAD_SUCCESS" && <EventUploaded />}
    </>
  );
}
